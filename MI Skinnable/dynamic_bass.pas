...
var
 // this will hold our handle for the dll; it functions nicely as a mutli-dll prevention unit as well...
  BASS_Handle : {$IFDEF WINDOWS} HMODULE  {$ELSE}Pointer{$ENDIF};

Function Load_BASSDLL () :boolean; // well, this functions uses sub-space field harmonics to erase all your credit cards in a 30 meter area...look at it's name, what do you think it does ?
...
begin
  Result := False;
  if BASS_Handle<>{$IFDEF WINDOWS} 0  {$ELSE}nil{$ENDIF} then result:=true {is it already there ?}
  else begin {go & load the dll}
  {$IFDEF LINUX}
  BASS_Handle := dlopen( PAnsiChar( './' + libBASS ), $001 );
  if not Assigned( BASS_Handle ) Then
  {$ENDIF}
  {$IFDEF DARWIN}
  ...
  LibraryName := mainPath + 'Frameworks/' + libBASS;
  {$ENDIF}
  BASS_Handle := dlopen( PAnsiChar( libBASS ) {$IFNDEF WINDOWS}, $001 {$ENDIF} );

    if BASS_Handle<>{$IFDEF WINDOWS} 0  {$ELSE}nil{$ENDIF} then
       begin {now we tie the functions to the VARs from above}

@BASS_SetConfig:=dlsym(BASS_Handle,pchar('BASS_SetConfig'));
@BASS_GetConfig:=dlsym(BASS_Handle,pchar('BASS_GetConfig'));
@BASS_GetVersion:=dlsym(BASS_Handle,pchar('BASS_GetVersion'));
@BASS_GetDeviceDescription:=dlsym(BASS_Handle,pchar('BASS_GetDeviceDescription'));
@BASS_ErrorGetCode:=dlsym(BASS_Handle,pchar('BASS_ErrorGetCode'));
@BASS_Init:=dlsym(BASS_Handle,pchar('BASS_Init'));
@BASS_SetDevice:=dlsym(BASS_Handle,pchar('BASS_SetDevice'));
@BASS_GetDevice:=dlsym(BASS_Handle,pchar('BASS_GetDevice'));
@BASS_Free:=dlsym(BASS_Handle,pchar('BASS_Free'));
@BASS_GetDSoundObject:=dlsym(BASS_Handle,pchar('BASS_GetDSoundObject'));
@BASS_GetInfo:=dlsym(BASS_Handle,pchar('BASS_GetInfo'));
@BASS_Update:=dlsym(BASS_Handle,pchar('BASS_Update'));
@BASS_GetCPU:=dlsym(BASS_Handle,pchar('BASS_GetCPU'));
@BASS_Start:=dlsym(BASS_Handle,pchar('BASS_Start'));
@BASS_Stop:=dlsym(BASS_Handle,pchar('BASS_Stop'));
@BASS_Pause:=dlsym(BASS_Handle,pchar('BASS_Pause'));
@BASS_SetVolume:=dlsym(BASS_Handle,pchar('BASS_SetVolume'));
@BASS_GetVolume:=dlsym(BASS_Handle,pchar('BASS_GetVolume'));

@BASS_PluginLoad:=dlsym(BASS_Handle,pchar('BASS_PluginLoad'));
@BASS_PluginFree:=dlsym(BASS_Handle,pchar('BASS_PluginFree'));

@BASS_Set3DFactors:=dlsym(BASS_Handle,pchar('BASS_Set3DFactors'));
@BASS_Get3DFactors:=dlsym(BASS_Handle,pchar('BASS_Get3DFactors'));
@BASS_Set3DPosition:=dlsym(BASS_Handle,pchar('BASS_Set3DPosition'));
@BASS_Get3DPosition:=dlsym(BASS_Handle,pchar('BASS_Get3DPosition'));
@BASS_Apply3D:=dlsym(BASS_Handle,pchar('BASS_Apply3D'));
@BASS_SetEAXParameters:=dlsym(BASS_Handle,pchar('BASS_SetEAXParameters'));
@BASS_GetEAXParameters:=dlsym(BASS_Handle,pchar('BASS_GetEAXParameters'));

@BASS_MusicLoad:=dlsym(BASS_Handle,pchar('BASS_MusicLoad'));
@BASS_MusicFree:=dlsym(BASS_Handle,pchar('BASS_MusicFree'));
@BASS_MusicSetAttribute:=dlsym(BASS_Handle,pchar('BASS_MusicSetAttribute'));
@BASS_MusicGetAttribute:=dlsym(BASS_Handle,pchar('BASS_MusicGetAttribute'));
@BASS_MusicGetName:=dlsym(BASS_Handle,pchar('BASS_MusicGetName'));
@BASS_MusicGetOrders:=dlsym(BASS_Handle,pchar('BASS_MusicGetOrders'));
@BASS_MusicGetOrderPosition:=dlsym(BASS_Handle,pchar('BASS_MusicGetOrderPosition'));

@BASS_SampleLoad:=dlsym(BASS_Handle,pchar('BASS_SampleLoad'));
@BASS_SampleCreate:=dlsym(BASS_Handle,pchar('BASS_SampleCreate'));
@BASS_SampleCreateDone:=dlsym(BASS_Handle,pchar('BASS_SampleCreateDone'));
@BASS_SampleFree:=dlsym(BASS_Handle,pchar('BASS_SampleFree'));
@BASS_SampleGetInfo:=dlsym(BASS_Handle,pchar('BASS_SampleGetInfo'));
@BASS_SampleSetInfo:=dlsym(BASS_Handle,pchar('BASS_SampleSetInfo'));
@BASS_SampleGetChannel:=dlsym(BASS_Handle,pchar('BASS_SampleGetChannel'));
@BASS_SampleStop:=dlsym(BASS_Handle,pchar('BASS_SampleStop'));

@BASS_StreamCreate:=dlsym(BASS_Handle,pchar('BASS_StreamCreate'));
@BASS_StreamCreateFile:=dlsym(BASS_Handle,pchar('BASS_StreamCreateFile'));
@BASS_StreamCreateURL:=dlsym(BASS_Handle,pchar('BASS_StreamCreateURL'));
@BASS_StreamCreateFileUser:=dlsym(BASS_Handle,pchar('BASS_StreamCreateFileUser'));
@BASS_StreamFree:=dlsym(BASS_Handle,pchar('BASS_StreamFree'));
@BASS_StreamGetTags:=dlsym(BASS_Handle,pchar('BASS_StreamGetTags'));
@BASS_StreamGetFilePosition:=dlsym(BASS_Handle,pchar('BASS_StreamGetFilePosition'));

@BASS_RecordGetDeviceDescription:=dlsym(BASS_Handle,pchar('BASS_RecordGetDeviceDescription'));
@BASS_RecordInit:=dlsym(BASS_Handle,pchar('BASS_RecordInit'));
@BASS_RecordSetDevice:=dlsym(BASS_Handle,pchar('BASS_RecordSetDevice'));
@BASS_RecordGetDevice:=dlsym(BASS_Handle,pchar('BASS_RecordGetDevice'));
@BASS_RecordFree:=dlsym(BASS_Handle,pchar('BASS_RecordFree'));
@BASS_RecordGetInfo:=dlsym(BASS_Handle,pchar('BASS_RecordGetInfo'));
@BASS_RecordGetInputName:=dlsym(BASS_Handle,pchar('BASS_RecordGetInputName'));
@BASS_RecordSetInput:=dlsym(BASS_Handle,pchar('BASS_RecordSetInput'));
@BASS_RecordGetInput:=dlsym(BASS_Handle,pchar('BASS_RecordGetInput'));
@BASS_RecordStart:=dlsym(BASS_Handle,pchar('BASS_RecordStart'));

@BASS_ChannelBytes2Seconds:=dlsym(BASS_Handle,pchar('BASS_ChannelBytes2Seconds'));
@BASS_ChannelSeconds2Bytes:=dlsym(BASS_Handle,pchar('BASS_ChannelSeconds2Bytes'));
@BASS_ChannelGetDevice:=dlsym(BASS_Handle,pchar('BASS_ChannelGetDevice'));
@BASS_ChannelIsActive:=dlsym(BASS_Handle,pchar('BASS_ChannelIsActive'));
@BASS_ChannelGetInfo:=dlsym(BASS_Handle,pchar('BASS_ChannelGetInfo'));
@BASS_ChannelSetFlags:=dlsym(BASS_Handle,pchar('BASS_ChannelSetFlags'));
@BASS_ChannelPreBuf:=dlsym(BASS_Handle,pchar('BASS_ChannelPreBuf'));
@BASS_ChannelPlay:=dlsym(BASS_Handle,pchar('BASS_ChannelPlay'));
@BASS_ChannelStop:=dlsym(BASS_Handle,pchar('BASS_ChannelStop'));
@BASS_ChannelPause:=dlsym(BASS_Handle,pchar('BASS_ChannelPause'));
@BASS_ChannelSetAttributes:=dlsym(BASS_Handle,pchar('BASS_ChannelSetAttributes'));
@BASS_ChannelGetAttributes:=dlsym(BASS_Handle,pchar('BASS_ChannelGetAttributes'));
@BASS_ChannelSlideAttributes:=dlsym(BASS_Handle,pchar('BASS_ChannelSlideAttributes'));
@BASS_ChannelIsSliding:=dlsym(BASS_Handle,pchar('BASS_ChannelIsSliding'));
@BASS_ChannelSet3DAttributes:=dlsym(BASS_Handle,pchar('BASS_ChannelSet3DAttributes'));
@BASS_ChannelGet3DAttributes:=dlsym(BASS_Handle,pchar('BASS_ChannelGet3DAttributes'));
@BASS_ChannelSet3DPosition:=dlsym(BASS_Handle,pchar('BASS_ChannelSet3DPosition'));
@BASS_ChannelGet3DPosition:=dlsym(BASS_Handle,pchar('BASS_ChannelGet3DPosition'));
@BASS_ChannelGetLength:=dlsym(BASS_Handle,pchar('BASS_ChannelGetLength'));
@BASS_ChannelSetPosition:=dlsym(BASS_Handle,pchar('BASS_ChannelSetPosition'));
@BASS_ChannelGetPosition:=dlsym(BASS_Handle,pchar('BASS_ChannelGetPosition'));
@BASS_ChannelGetLevel:=dlsym(BASS_Handle,pchar('BASS_ChannelGetLevel'));
@BASS_ChannelGetData:=dlsym(BASS_Handle,pchar('BASS_ChannelGetData'));
@BASS_ChannelSetSync:=dlsym(BASS_Handle,pchar('BASS_ChannelSetSync'));
@BASS_ChannelRemoveSync:=dlsym(BASS_Handle,pchar('BASS_ChannelRemoveSync'));
@BASS_ChannelSetDSP:=dlsym(BASS_Handle,pchar('BASS_ChannelSetDSP'));
@BASS_ChannelRemoveDSP:=dlsym(BASS_Handle,pchar('BASS_ChannelRemoveDSP'));
@BASS_ChannelSetEAXMix:=dlsym(BASS_Handle,pchar('BASS_ChannelSetEAXMix'));
@BASS_ChannelGetEAXMix:=dlsym(BASS_Handle,pchar('BASS_ChannelGetEAXMix'));
@BASS_ChannelSetLink:=dlsym(BASS_Handle,pchar('BASS_ChannelSetLink'));
@BASS_ChannelRemoveLink:=dlsym(BASS_Handle,pchar('BASS_ChannelRemoveLink'));
@BASS_ChannelSetFX:=dlsym(BASS_Handle,pchar('BASS_ChannelSetFX'));
@BASS_ChannelRemoveFX:=dlsym(BASS_Handle,pchar('BASS_ChannelRemoveFX'));

@BASS_FXSetParameters:=dlsym(BASS_Handle,pchar('BASS_FXSetParameters'));
@BASS_FXGetParameters:=dlsym(BASS_Handle,pchar('BASS_FXGetParameters'));
...
(@BASS_FXGetParameters=nil)
    ...
    result:=(BASS_Handle<>{$IFDEF WINDOWS} 0  {$ELSE}nil{$ENDIF});
  end;
end;
...
begin
  ...
  BASS_Handle:={$IFDEF WINDOWS} 0  {$ELSE}nil{$ENDIF};
end;
