...
{ Oscilloscope Visualyzation by Alessandro Cappellozza
  ...
  Typecasted Hiword and loword to smallint (to avoid range error)
...
//      UseBkg   : Boolean;
    ...
    public
     ...
     procedure Draw(HWND : THandle; const WaveData : TWaveData; X, Y : Integer);
...
//          UseBkg := False;
     ...
     procedure TOcilloScope.SetBackGround (BkgCanvas : TGraphic);
      begin
//        UseBkg := Active;
        BackBmp.Canvas.Draw(0, 0, BkgCanvas);
      end;

     procedure TOcilloScope.Draw(HWND : THandle; const WaveData : TWaveData; X, Y : Integer);
